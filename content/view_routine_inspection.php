<div class="page-title">
	<div class="title-env">
		<h1 class="title">Detail View Routine Inspection</h1>
		<p class="description">Detail View Routine Inspection <b>4 April 2016 - 4 April 2017</b></p>
	</div>
	<div class="breadcrumb-env">
		<ol class="breadcrumb bc-1" >
			...
			<li class="active">
				<strong>Ruotine Inspection View</strong>
			</li>
		</ol>
