		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="hidden" id="data_customer" class="form-control" name="data_customer" data-validate="required" data-message-required="Please Input Customer Name." placeholder="Customer Name" />
						</div>
					</div>
					<div class="form-group-separator"></div>
					<div class="form-group">
