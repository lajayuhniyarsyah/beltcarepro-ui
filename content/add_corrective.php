	...
	<div class="panel panel-default">
		...
		<script type="text/javascript">
			...
			<table class="table table-bordered" id="overview-table">
				                      					...
				                      					<span class="float-right">
				                      						<!-- <a href="javascript:;" onclick="jQuery('.inspect_corrective').modal('show', {backdrop: 'static'});"> -->
					                      						<div class="style-radio">
																	<input type="checkbox" name="radio" id="radio1" class="checkbox" checked/>
																	<label class="label-radio status-step" for="radio1">Passed</label>
																</div>
															<!-- </a> -->
				                      					</span>
				                      				</td>
			                      			...
			                      			<tr>
			                      				...
			                      				<td class="col-md-1">
			                      					<span class="float-right">
			                      						...
			                      						<div class="style-radio">
															<input type="checkbox" name="radio" id="radio1" class="checkbox" checked/>
															<label class="label-radio status-step" for="radio2">Passed</label>
														</div>
															<!-- </a> -->
			                      					</span>
			                      				</td>
				                      			...
				                      			<tr>
				                      				...
				                      				<td class="col-md-1">
				                      					<span class="float-right">
				                      						...
				                      						<div class="style-radio">
																<input type="checkbox" name="radio" id="radio1" class="checkbox" checked/>
																<label class="label-radio status-step" for="radio3">Passed</label>
															</div>
															<!-- </a> -->
				                      					</span>
				                      				</td>
				                      				...
				                      				<td class="col-md-1">
				                      					<span class="float-right">
				                      						<!-- <a href="javascript:;" onclick="jQuery('.inspect_corrective').modal('show', {backdrop: 'static'});"> -->
					                      						<div class="style-radio">
																	<input type="checkbox" name="radio" id="radio1" class="checkbox" checked/>
																	<label class="label-radio status-step" for="radio4">Passed</label>
																</div>
															<!-- </a> -->
				                      					</span>
				                      				</td>
		      ...
		      <div id="body-2">
			        <tr data-toggle="collapse" data-target="#text-2" class="accordion-toggle collapsed">
			            <td></td>
				                      			...
				                      			<tr>
				                      				...
				                      				<td class="col-md-2">
				                      					<span class="float-right">
				                      						<a href="javascript:;" onclick="jQuery('.inspect_corrective').modal('show', {backdrop: 'static'});">
					                      						<div class="style-radio">
																	<input type="checkbox" name="radio" id="radio1" class="checkbox"/>
																	<label class="label-radio waiting-action" for="radio5">Waiting Action</label>
																</div>
															</a>
				                      					</span>
				                      				</td>
